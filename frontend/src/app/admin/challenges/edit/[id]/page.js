...
export default function EditChallengePage({ params }) {
  ...
  // Define fetchChallenge with useCallback to avoid dependency issues
  const fetchChallenge = useCallback(async () => {
    try {
      setIsLoading(true);
      // This endpoint is still /api/challenges/${id} because we're using the public API to fetch challenge details
      // If you have a separate admin endpoint with additional fields, use /api/admin/challenges/${id} instead
  ...
  // If loading challenge data
  if (isLoading) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-8 bg-white">
        <p className="text-center text-black">Loading challenge data...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 bg-white">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-black">Edit Challenge</h1>
